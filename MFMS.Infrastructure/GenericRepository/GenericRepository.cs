...
namespace MFMS.Infrastructure.GenericRepository
{
    public class GenericRepository<TEntity> where TEntity : class
    {
        #region Private member variables...
        internal EF_DbContext _dbContext;
        ...
        public GenericRepository(EF_DbContext dbContext)
        {
        ...
        /// <summary>
        /// generic method to get the count
        /// </summary>
        /// <param name="predicate"></param>
        /// <returns></returns>
        public int QueryCount(System.Linq.Expressions.Expression<Func<TEntity, Boolean>> predicate)
        {
            int queryCount = DbSet.Count(predicate);
            return queryCount;
        }
